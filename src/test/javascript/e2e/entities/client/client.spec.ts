...
describe('Client e2e test', () => {
  ...
  it('should create and save Clients', async () => {
    ...
    await promise.all([clientUpdatePage.setAdresseInput('adresse'), clientUpdatePage.setNameInput('Kuq6')]);

    expect(await clientUpdatePage.getAdresseInput()).to.eq('adresse', 'Expected Adresse value to be equals to adresse');
    expect(await clientUpdatePage.getNameInput()).to.eq('Kuq6', 'Expected Name value to be equals to Kuq6');
